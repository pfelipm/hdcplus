  ...
  function interpretarVectorIndices(vector, longitud, contexto) {
    ...
    return vector.flat().reduce((resultado, indice) => {
      ...
      if (typeof indice == 'number') {
        ...
        // ### El selector de columna es una cadena de texto que enumera los encabezados de las columnas que se desean devolver ###
        ...
        // ### El selector de fila es una cadena de texto que enumera los encabezados de las filas que se desean devolver ###
