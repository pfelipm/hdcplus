...
- **Nueva función de Marcos de Color**: Herramienta visual para generar bordes estéticos con opciones de grosor, margen interior (padding) y combinación de celdas inteligente.
...
- **principal.gs**: 
    ...
    - Estandarización global de `ui.alert()` utilizando la constante `ENCABEZADO_ALERTAS` y corrección de firmas de método.
    - Refactorización de la lógica de dimensiones (`insertarFyC_core`, `eliminarFyC_core`) e implementación de la función de "Encuadre total".
- **hojas.gs**:
    ...
    - Inclusión del motor geométrico para la generación de Marcos de Color.
...
- **fx_repetir.gs**:
    ...
    - Corregido el bug de referencias compartidas en memoria.
- **protegerCeldas.gs**:
    ...
    - Soporte multioja y feedback visual mejorado con "toasts" de progreso.
